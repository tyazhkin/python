...
canvaHeight = 500
window = tkinter.Tk()
canvas = tkinter.Canvas(window, width=canvasWidth, height=canvaHeight, bg="dodgerblue4")
canvas.pack()
...
ballMoveX = 4
ballMoveY = -4
setBatTop = canvaHeight-40
setBatBottom = canvaHeight-30
